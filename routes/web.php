...
Route::group(['prefix' => '/product'], function () {
    ...
    Route::post('/{id}/like',[ProductController::class, 'like'])->name('product.like')->middleware('auth');
    Route::get('/addCart/{id}',[ProductController::class, 'addCart'])->name('product.cart');
    Route::get('/deleteCart/{id}',[ProductController::class, 'deleteCart'])->name('product.deleteCart');
    Route::get('/star/{id}',[ProductController::class, 'addStar'])->name('product.star')->middleware('auth');
});
