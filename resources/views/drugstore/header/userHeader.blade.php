    ...
    <div class="nav-bar">
        ...
        <div class="nav-group">
            ...
            <div class=" nav-login">
                ...
                @endif
                <div class="user-menu">
                    <div class="user-menu__item"><a href="{{route('user.showUser')}}">ユーザー詳細</a></div>
                    <div class="user-menu__item"><a href="{{route('user.showOrder')}}">注文履歴</a></div>
            ...
            <div class="re-navbar">
                ...
                <div class="re-navbar__menu">
                    <div class="user-menu__item"><a href="{{route('user.showUser')}}">ユーザー詳細</a></div>
                    <div class="user-menu__item"><a href="{{route('user.showOrder')}}">注文履歴</a></div>
                    <div class="user-menu__item"><a href="{{route('contact.userIndex')}}">問い合わせ</a></div>
                    <div class="user-menu__item">
                        <form action="{{ route('logout') }}" method="POST">
                            @csrf
                            <button type="submit">ログアウト</button>
