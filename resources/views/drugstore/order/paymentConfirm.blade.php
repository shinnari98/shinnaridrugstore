...
<div class="app-container">
    <div class="product-wrap">
        ...
        <form action="{{route('payment.complete')}}" class="payment-main" method="POST">
            @csrf
            @method('POST')
            <div class="payment-body__wrap">
                <div class="form-back">
                    {{-- <button type="submit" name="back" class="back" id="back" value="backPayment">
                        ...
                        <a href="{{route('payment')}}"><i class="fa-solid fa-arrow-left"></i></a>
                </div>
                    ...
                    <div class="order-detail__wrap">
                        ...
                        <ul class="order-list">
                            ...
                            <li class="order-group">
                                ...
                                <div class="order-price__one">{{$product['price']}}円</div>
                            </li>
                            @endforeach
                        </ul>
